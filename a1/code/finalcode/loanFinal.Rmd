...
plot(as.numeric(loansRaw$FICO.Range), rates, pch = 19, col = loansRaw$Loan.Length, cex.axis=cx,cex.lab=cx, xlab="FICO Range", ylabel="Rate")
plot(loansRaw$Amount.Funded.By.Investors, rates, col=range, pch=ifelse(as.numeric(loansRaw$Loan.Length) == 2, 19, 21), cex.axis=cx,cex.lab=cx, xlab="Amounf funded (USD)", ylabel="Rate")
```
